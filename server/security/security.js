...
app.post(properties.api + '/changePassword', function (req, res) {
    ...
    db_clinicalreports_db.User.findOne({
...
var createUser = function () {
    ...
    db_clinicalreports_db = require('../db/clinicalreports_db_schema.js');
    db_clinicalreports_db.User.count().exec(function (err, count) {
        if (count == 0) {
            var admin = new db_clinicalreports_db.User({
                username: 'admin',
